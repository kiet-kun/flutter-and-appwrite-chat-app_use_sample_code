...
class _$_MessageState implements _MessageState {
  ...
  @override
  String toString() {
    return 'MessageState(myUserId: $myUserId, friendUserId: $friendUserId, message: $message, messageType: $messageType, loading: $loading, messages: $messages, file: $file, onlineStatus: $onlineStatus)';
  }
...
abstract class _MessageState implements MessageState {
  factory _MessageState(
      ...
      final List<MessageRealm> messages,
      final File? file,
      final String onlineStatus}) = _$_MessageState;
